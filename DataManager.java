...
public class DataManager {
    ...
    public static void save(){
        File inventory_fp = new File("E:\\java\\PL_Project-2\\product\\inventory.txt");
        try {
    ...
    public static void retrieve(){
        ...
        String inventory_fp = "E:\\java\\PL_Project-2\\product\\inventory.txt";
    ...
    public static void recordProduct(Inventory product){
        File record_fp = new File ("E:\\java\\PL_Project-2\\product\\product_history\\" + product.date + ".txt");
        try {
            if(!record_fp.exists())
